...
5. **Answer design.** At least 30 questions per set contain a near-miss pair. Among single-choice questions, the correct option is strictly longer than every other option in at most 18. Among single-choice questions, each letter is correct 13 to 17 times. A set has at most 3 choose-two questions.
