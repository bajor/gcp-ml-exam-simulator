...
- [Architecture](/architecture.md) - Module ownership, question lifecycle, attempt data flow, persistence, quality gates, and deployment.
- [Context](/context/index.md) - Project and exam vocabulary, including the current product names questions must use.
